...
if __name__ == '__main__':
    ...
    #
    # print('数据权限是全公司 对比各个时间的产品销售额')
    # _all_data=result_product_amount_all_data.result_product_amount_all_data()
    # _all_data.all_data()
    # print('数据权限是所属部门以及下属 对比各个时间的产品销售额')
    # _self_and_subordinate_department_own=result_product_amount_self_and_subordinate_department_own.result_product_amount_self_and_subordinate_department_own()
    # _self_and_subordinate_department_own.self_and_subordinate_department_own()
    # print('数据权限是所属部门 对比各个时间的产品销售额')
    # _self_department_own=result_product_amount_self_department_own.result_product_amount_self_department_own()
    # _self_department_own.self_department_own()
    # print('数据权限是个人 对比各个时间的产品销售额')
    # _self_own=result_product_amount_self_own.result_product_amount_self_own()
    # _self_own.self_own()
    #
